...
See [docs/RSMESH-BBS-SYSOP-GUIDE.md](docs/RSMESH-BBS-SYSOP-GUIDE.md) for configuration, operator concepts, and a complete guide to every admin menu, input prompt, and valid choice.
