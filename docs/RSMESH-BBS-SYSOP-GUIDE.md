...
Fortune has no admin screen. Node Info admin is view-only (**List Node Info**). See [Module development](RSMESH-BBS-DEVELOPER-GUIDE.md#modules) in the Developer Guide.
